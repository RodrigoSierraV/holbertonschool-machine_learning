...
class Yolo:
    ...
    def nms(self, filtered, thresh, scores):
        ...
        filtered: boxes that belong to a class
    ...
    def non_max_suppression(self, filtered_boxes, box_classes, box_scores):
        ...
        for c in unique_classes:
            ...
            box_predictions.append(filtered)
            predicted_box_classes.append(classes)
            predicted_box_scores.append(scores)
    ...
    def load_images(folder_path):
        ...
        images = [cv2.imread(img, 1) for img in image_paths]
    ...
    def preprocess_images(self, images):
        ...
        return np.stack(n_images, axis=0), np.stack(shape, axis=0)
